...
#ifndef VENTUSIPC_SWIFT_H
#define VENTUSIPC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VentusIPC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP9VentusIPC17VentusXPCProtocol_")
@protocol VentusXPCProtocol
/// Returns current daemon telemetry as JSON Data.
/// reply: (Data) -> Void receives a JSON-encoded TelemetrySnapshot
- (void)getStatusWithReply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
/// Returns current daemon configuration as JSON Data.
- (void)getConfigWithReply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
/// Sets daemon configuration from JSON Data.
/// reply: (Data) -> Void receives validation result (error message or empty if ok)
- (void)setConfig:(NSData * _Nonnull)configData reply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
/// Sets the active profile by name.
- (void)setProfile:(NSString * _Nonnull)profileName reply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
/// Enables armed mode (hardware writes allowed).
- (void)armWithReply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
/// Disables armed mode (hardware writes blocked).
- (void)disarmWithReply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
/// Forces fans to Apple auto mode (FxMd=0).
- (void)setAppleAutoWithReply:(void (^ _Nonnull)(NSData * _Nonnull))reply;
@end
